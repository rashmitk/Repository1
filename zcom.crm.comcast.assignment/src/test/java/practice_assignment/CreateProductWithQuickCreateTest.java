	...
	public static void main(String[] args) throws Throwable {
	   ...
	   //3.Select product from quick create drop down
		...
		//4. create a new product with product name-Sony
			...
			String productName=workbook.getSheet("Sheet1").getRow(1).getCell(2).getStringCellValue();
			driver.findElement(By.name("productname")).sendKeys(productName);
			WebElement userRadioButton = driver.findElement(By.xpath("//input[not(@id='assigntype') and @type='radio' and @value='U']"));
		...
		//Assert.assertEquals(expectedurl,afterLogoutUrl);
